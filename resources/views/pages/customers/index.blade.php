                ...
                <div class="modal-body">
                    <form action="{{ route('customers.store') }}" method="post" id="edit_form"
                        ...
                        <div class="modal-form-item">
                            ...
                            <div class="form-group">
                                <label for="name">Zip Code *</label>
                                <input type="number" name="zipcode" id="zipcode" min="0" class="form-control"
                                    required>
                            </div>
                            {{-- <input type="hidden" name="image" id="create_image" class="form-control">
                        <div class="form-group">
    ...
    @push('js')
        ...
        <script>
            ...
            function showData(ele) {
                ...
                $("#full_address").val(ele.getAttribute("data-full_address"));
                $("#city").val(ele.getAttribute("data-city"));
                $("#state_id").val(ele.getAttribute("data-state_id"));
                $("#zipcode").val(ele.getAttribute("data-zipcode"));
            ...
            function deletePublic(ele) {
                var title = ' you want to delete this Customer ?';
                Swal.fire({
                    title: '',
                    text: title,
