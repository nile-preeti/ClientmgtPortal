                        ...
                        <div class="client-form-card">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="service_id" class="form-control" id="serviceDropdown">
                                        <option value="0">--Select Service--</option>
                                        @foreach ($services as $item)
                                            <option value="{{ $item->id }}" 
                                                @if(isset($job_schedule) && $job_schedule->service_id == $item->id) selected @endif>
                                                {{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="sub_category_id" class="form-control" id="subcategoryDropdown">
                                        ...
                                        @if(isset($job_schedule) && $job_schedule->service)
                                            @foreach ($job_schedule->service->subCategories as $subcategory)
                                                <option value="{{ $subcategory->id }}" 
                                                    @if($job_schedule->sub_category_id == $subcategory->id) selected @endif>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group"><label for="">Job Details</label>
                                        <textarea cols="30" rows="3" name="description" class="form-control">@if (isset($job_schedule)){{ trim($job_schedule->description) }}@endif</textarea>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        $('#serviceDropdown').on('change', function() {
            ...
            if (serviceId == 0) {
                $('#subcategoryDropdown').html('<option value="0">--Select Sub Category--</option>');
                return;
            }
